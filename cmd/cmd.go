...
import (
	...
	"github.com/gzl-tommy/micro/v2/plugin"
	"github.com/gzl-tommy/micro/v2/plugin/build"
	"github.com/gzl-tommy/micro/v2/server"
	"github.com/gzl-tommy/micro/v2/service"

	// clients
	"github.com/gzl-tommy/micro/v2/client/api"
	"github.com/gzl-tommy/micro/v2/client/bot"
	"github.com/gzl-tommy/micro/v2/client/cli"
	"github.com/gzl-tommy/micro/v2/client/cli/new"
	"github.com/gzl-tommy/micro/v2/client/cli/util"
	"github.com/gzl-tommy/micro/v2/client/proxy"
	"github.com/gzl-tommy/micro/v2/client/web"

	// services
	"github.com/gzl-tommy/micro/v2/service/auth"
	"github.com/gzl-tommy/micro/v2/service/broker"
	"github.com/gzl-tommy/micro/v2/service/config"
	"github.com/gzl-tommy/micro/v2/service/debug"
	"github.com/gzl-tommy/micro/v2/service/health"
	"github.com/gzl-tommy/micro/v2/service/network"
	"github.com/gzl-tommy/micro/v2/service/registry"
	"github.com/gzl-tommy/micro/v2/service/router"
	"github.com/gzl-tommy/micro/v2/service/runtime"
	"github.com/gzl-tommy/micro/v2/service/store"
	"github.com/gzl-tommy/micro/v2/service/tunnel"

	// internals
	inauth "github.com/gzl-tommy/micro/v2/internal/auth"
	"github.com/gzl-tommy/micro/v2/internal/helper"
	"github.com/gzl-tommy/micro/v2/internal/platform"
	_ "github.com/gzl-tommy/micro/v2/internal/plugins"
	"github.com/gzl-tommy/micro/v2/internal/update"
	_ "github.com/gzl-tommy/micro/v2/internal/usage"
)
