...
import (
	...
	tmpl "github.com/gzl-tommy/micro/v2/internal/template"
	"github.com/gzl-tommy/micro/v2/internal/usage"
...
func protoComments(goDir, alias string) []string {
	return []string{
		...
		"go get github.com/gzl-tommy/micro/v2/cmd/protoc-gen-micro",
